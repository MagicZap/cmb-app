          ...
          <tbody className="divide-y divide-slate-100">
            {appointments.map((app, index) => (
              <tr key={`${app.id}-${index}`} className="hover:bg-slate-50/50 transition-colors">
                ...
                <td className={`px-3 py-2.5 text-xs font-medium ${app.plano?.toLowerCase() === 'particular' ? 'text-green-600 bg-green-50' : 'text-slate-600'}`}>{app.plano?.toLowerCase() === 'particular' && <span className="mr-1">⭐</span>}{app.plano}</td>
